...
# from django.contrib.auth.forms import UserCreationForm #direct from django
from django.contrib import messages #for messages 
from .forms import UserRegisterForm, UserUpdateForm, ProfileUpdateForm #created form template 
